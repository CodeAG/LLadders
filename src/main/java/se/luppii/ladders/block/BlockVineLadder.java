...
public class BlockVineLadder extends BlockGenericLadder implements ITileEntityProvider {
	...
	public BlockVineLadder(boolean par1Boolean) {
	...
	public TileEntity createTileEntity(World world, int metadata) {
		...
		try {
			TileEntityVineLadder te = TileEntityVineLadder.class.newInstance();
			return te;
		}
		catch (IllegalAccessException ex) {
			FMLLog.severe(References.MOD_NAME, "Unable to create TileEntityVineLadder instance.");
			return null;
		}
