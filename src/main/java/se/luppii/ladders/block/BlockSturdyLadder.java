...
public class BlockSturdyLadder extends BlockGenericLadder implements ITileEntityProvider {
	...
	public boolean canPlaceBlockAt(World par1World, int par2, int par3, int par4) {
		...
		return par1World.isSideSolid(par2, par3 - 1, par4, UP) || par1World.isSideSolid(par2 - 1, par3, par4, EAST)
				|| par1World.isSideSolid(par2 + 1, par3, par4, WEST) || par1World.isSideSolid(par2, par3, par4 - 1, SOUTH)
				|| par1World.isSideSolid(par2, par3, par4 + 1, NORTH) || par1World.getBlock(par2, par3 - 1, par4) == this
